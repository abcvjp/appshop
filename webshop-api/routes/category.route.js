...
router.put('/:categoryId', authenticate({ required: true }), authorize(Role.Admin), validate(categoryValidation.updateCategory), categoryController.updateCategory)
router.delete('/', authenticate({ required: true }), authorize(Role.Admin), validate(categoryValidation.deleteCategories), categoryController.deleteCategories)
router.delete('/:categoryId', authenticate({ required: true }), authorize(Role.Admin), validate(categoryValidation.deleteCategory), categoryController.deleteCategory)
