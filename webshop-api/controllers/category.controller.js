...
exports.updateCategory = asyncHandler(async (req, res, next) => {
	...
	const { name, parent_id, description, published, meta_title, meta_description, meta_keywords } = req.body
	const result = await categoryService.updateCategory({ id: categoryId, name, parent_id, description, published, meta_title, meta_description, meta_keywords })
	res.status(200).json(result)
})
