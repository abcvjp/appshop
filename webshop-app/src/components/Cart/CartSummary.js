	...
	return (
		<Paper elevation={0} className={classes.root}>
			...
			<Box className={classes.margin} display="flex" justifyContent="space-between">
				...
				<Typography className={classes.total}>${discount + subtotal}</Typography>
			</Box>
			<Button className={classes.checkout} color="primary" variant="contained" size="large" fullWidth disableElevation
