module.exports = {
  tags: ['product'],
  summary: 'Search products with multiple filters',
  operationId: 'searchProducts',
  description:
    'Search products with multiple filters. This is a quite complicate endpoint, note that normal user always receive products with <b>enable</b> & <b>published</b> & <b>in_stock</b> attribute is <b>true</b> while admin can do whatever',
  security: [
    {},
    {
      access_token: []
  ...
  parameters: [
    {
      $ref: '#/parameters/SearchKeywordParam'
    },
    {
            ...
            data: [
              {
                ...
                relevance: 0.012539339251816273
              },
              {
